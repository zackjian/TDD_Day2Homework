...
namespace PotterShoppingCart.Tests
{
    ...
    public class PotterShoppingCartTests
    {
        ...
        [TestMethod()]
        public void Test_Fisrt_Episode_Buy_1_Second_Episode_Buy_1_Third_Episode_Buy_1_Fourth_Episode_Buy_1_Fifth_Episode_Buy_1_Price_Should_Be_100_Multiply_5_Multiply_Dot75_Equal_375()
        {
            var potterEpisode = new PotterEpisode();
            ...
            var orders = new List<Order>
            {
                ...
                new Order { Name= potterEpisode.Episode3, Price=100, Qty=1 },
                new Order { Name= potterEpisode.Episode4, Price=100, Qty=1 },
                new Order { Name= potterEpisode.Episode5, Price=100, Qty=1 }
            };
        ...
        [TestMethod()]
        public void Test_Fisrt_Episode_Buy_1_Second_Episode_Buy_1_Third_Episode_Buy_2_Price_Should_Be_100_Multiply_3_Multiply_Dot9_SUM_100_Equal_370()
        {
            var potterEpisode = new PotterEpisode();
